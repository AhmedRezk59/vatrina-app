...
class SendVendorResetLinkEmail extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        ->subject('بريد إعادة تعيين كلمة السر')
            ...
            ->action('إعادة تعيين كلمة السر', config('app.frontend_url') . (route('vendor.password.store', ['token' => $this->token], false)))
